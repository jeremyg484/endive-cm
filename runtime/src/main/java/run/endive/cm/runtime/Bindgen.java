...
public @interface Bindgen {
    ...
    /**
     * The world whose bindings are generated. May be left out when the package declares exactly
     * one, in which case {@link #path} or {@link #inline} has to say where the WIT is.
     */
