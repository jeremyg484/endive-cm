...
/**
 * Binds {@link VariantValue} to {@code variant} and to the three shorthands that despecialize into
 * one. Those are {@code enum} (cases with no payload), {@code option} (cases {@code none} and
