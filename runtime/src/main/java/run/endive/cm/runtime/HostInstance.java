...
public final class HostInstance {
    ...
    public static final class Builder {
        ...
        /** Exports a function implemented in Java, of the type an importer will be matched against. */
    ...
    /**
     * Builds a host function against {@code owner}, which is the instance a call to it enters and
     * the space its type resolves against. Shared with {@link HostFunction}.
     */
