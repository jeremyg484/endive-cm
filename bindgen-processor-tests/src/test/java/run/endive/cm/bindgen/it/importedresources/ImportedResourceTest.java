...
public class ImportedResourceTest {
    ...
    /** The guest constructs a host resource, passing an enum the bindings convert before the call. */
    @Test
    ...
    /** A method taking an enum and a string, both converted before the call. */
    @Test
